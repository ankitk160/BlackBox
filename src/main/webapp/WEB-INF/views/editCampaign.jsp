				...
				<div class="col-lg-12 mx-auto">
					<div class="card">
						<div class="card-body p-4">
							<form id="addCampaignValidation" action="updateCampaignData"
								method="post">
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="servicename"
											name="servicename" value="${campaign.servicename}"
											disabled="disabled">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<select class="form-select" id="territory" name="territory"
											data-placeholder="Select Territory" disabled="disabled">
											<option>${campaign.territoryName}</option>
										</select>
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<select class="form-select" id="operator" name="operator"
											data-placeholder="Select Operator" disabled="disabled">
											<option>${campaign.operatorName}</option>
										</select>
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<select class="form-select" id="pinLength" name="pinLength"
											...
											<option value="4"
												<c:if test="${campaign.pinLength == 4}">selected</c:if>>4</option>
											<option value="5"
												<c:if test="${campaign.pinLength == 5}">selected</c:if>>5</option>
											<option value="6"
												<c:if test="${campaign.pinLength == 6}">selected</c:if>>6</option>
										</select>
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="number" class="form-control" id="price"
											name="price" min="0" step="0.01" value="${campaign.price}"
											disabled="disabled">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="number" class="form-control" id="chargingmode"
											...
											value="${campaign.chargingmode}" disabled="disabled">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<select class="form-select" id="partnerName"
											...
											disabled="disabled">
											<option>${campaign.partnerName}</option>
										</select>
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<select class="form-select" id="lpPageLang" name="lpPageLang"
											...
											<option value="en"
												<c:if test='${campaign.lpPageLang == "en"}'>selected</c:if>>English</option>
											<option value="ar"
												<c:if test='${campaign.lpPageLang == "ar"}'>selected</c:if>>Arabic</option>
											<option value="fr"
												<c:if test='${campaign.lpPageLang == "fr"}'>selected</c:if>>French</option>
										</select>
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" id="mailid"
											name="mailid" value="${campaign.mailid}">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="unsubKeyword"
											name="unsubKeyword" value="${campaign.unsubKeyword}"
											disabled="disabled">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="number" class="form-control" id="unsubSC"
											name="unsubSC" value="${campaign.unsubSC}">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="number" class="form-control" id="dailyCap"
											name="dailyCap" min="0" value="${campaign.dailyCap}">
									</div>
								</div>
								<div class="row mb-3">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="url" class="form-control" id="portalUrl"
											name="portalUrl" value="${campaign.portalUrl}">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="url" class="form-control" id="pinGenUrl"
											name="pinGenUrl" value="${campaign.pinGenUrl}">
									</div>
								</div>
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="url" class="form-control" id="pinValidUrl"
											name="pinValidUrl" value="${campaign.pinValidUrl}">
									</div>
								</div>
								<sec:authorize access="hasRole('ROLE_ADMIN')">
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<div class="form-check form-switch form-check-danger">
												<input class="form-check-input" type="checkbox"
													...
													aria-expanded="${campaign.antiFaurdFlag == 'Y' ? 'true' : 'false'}"
													aria-controls="antiFaurdUrlContainer"
													<c:if test='${campaign.antiFaurdFlag == "Y"}'>checked</c:if>>
											</div>
										</div>
									</div>
									<div
										class="row collapse mb-3 <c:if test='${campaign.antiFaurdFlag == "Y"}'>show</c:if>"
										id="antiFaurdUrlContainer">
								...
								<sec:authorize access="hasRole('ROLE_ADMIN')">
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="url" class="form-control" id="pinValidUrl"
												name="bannerUrl" value="${campaign.bannerUrl}">
										</div>
									</div>
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control"
												...
												value="${campaign.displayServiceName}">
										</div>
									</div>
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													...
													<c:if test='${campaign.displayPartnerName == "Y"}'>checked</c:if>>
											</div>
										</div>
									</div>
								</sec:authorize>

...
<body>
				...
				<div class="col-lg-12 mx-auto">
					<div class="card">
						<div class="card-body p-4">
							<form id="addOfferValidation" action="saveOfferData"
								method="post">
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="offerName"
											name="offerName" placeholder="Enter Offer Name">
									</div>
								</div>
								<div class="row mb-3">
								...
								<div class="row mb-3">
									<label for="operator" class="col-sm-3 col-form-label">Select
										Operator</label>
									<div class="col-sm-9">
										<select class="form-select" id="operator" name="operatorid"
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="number" class="form-control" id="pubBid"
											name="pubBid" min="0" step="0.01" placeholder="Enter Pub Bid">
									</div>
								</div>
								<div class="row mb-3">
								...
								<sec:authorize access="hasRole('ROLE_ADMIN')">
									<div class="row mb-3">
										<label for="FailSaveCmpId" class="col-sm-3 col-form-label">Select
											Fail Save Camp ID</label>
										<div class="col-sm-9">
											<select class="form-select" id="FailSaveCmpId"
												name="FailSaveCmpId"
												data-placeholder="Select Fail Save Camp ID">
											</select>
										</div>
									</div>
									<div class="row mb-3">
	...
	<script src="/blackbox/resources/assets/js/addOffer.js"></script>
</body>

...
<body>
			...
			<div class="row pt-5">
				<div class="col-lg-12">
					<div class="text-center error-pages">
						<h1 class="error-title text-warning mb-3">404</h1>
						<h2 class="error-sub-title text-white">NOT FOUND</h2>

						<p class="error-message text-white text-uppercase">SORRY, AN
							ERROR HAS OCCURED, REQUESTED PAGE NOT FOUND!</p>
	...
	<!-- <script src="/maxPro/resources/assets/js/pace.min.js"></script> -->
</body>
</html>

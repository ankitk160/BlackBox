			...
			<div class="row pt-5">
				<div class="col-lg-12">
					<div class="text-center error-pages">
						<h1 class="error-title text-warning mb-3">403</h1>
						<h2 class="error-sub-title text-white">FORBIDDEN</h2>

						<p class="error-message text-white text-uppercase">SORRY, IT'S
							NOT ALLOWED TO GO BEYOND THIS POINT!</p>

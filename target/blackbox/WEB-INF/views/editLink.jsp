				...
				<div class="col-lg-12 mx-auto">
					<div class="card">
						<div class="card-body p-4">
							<form id="addLinkValidation" action="updateSmartLink"
								method="post">
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="name" name="name"
											placeholder="Enter Link Name" value="${linkData.name}"
											disabled="disabled">
									</div>
								</div>
								<div class="row mb-3">
										...
										<select class="form-select" id="territory" name="territory"
											...
											<c:forEach items="${allTerritoryDataList}" var="territory">
												<option value="${territory.id}"
													<c:if test="${linkData.territoryid == territory.id}">selected</c:if>>${territory.id}-
										...
										<select class="form-select" id="agency" name="agency"
											...
											<c:forEach items="${allAgencyDataList}" var="agency">
												<option value="${agency.id}"
													...
													<c:if test="${linkData.agency == agency.id}">selected</c:if>>${agency.id}-
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<select class="form-select" id="lang" name="lang"
											...
											<option value="en"
												<c:if test="${linkData.lang == 'en'}">selected</c:if>>English</option>
											<option value="fr"
												<c:if test="${linkData.lang == 'fr'}">selected</c:if>>French</option>
											<option value="ar"
												<c:if test="${linkData.lang == 'ar'}">selected</c:if>>Arabic</option>
										</select>
									</div>
								</div>
								<div class="row">
